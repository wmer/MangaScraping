...
namespace MangaScraping.Managers {
    public class MangaLivreSourceManager : HqSourceManager<MangasProjectSource> {
        public MangaLivreSourceManager(string homeLink, string libraryLink, CacheManager cacheManager, MangasProjectSource hqSource) : base(homeLink, libraryLink, cacheManager, hqSource) {
        }
